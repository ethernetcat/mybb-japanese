...
$l['nav_usercp'] = "ユーザーコントロールパネル";
$l['nav_profile'] = "プロフィールを編集";
$l['nav_options'] = "オプションを編集";
$l['nav_email'] = "Eメールアドレスを変更";
$l['nav_password'] = "パスワードを変更";
$l['nav_changename'] = "ユーザー名を変更";
$l['nav_subthreads'] = "購読スレッド";
$l['nav_forumsubscriptions'] = "購読フォーラム";
$l['nav_editsig'] = "署名を編集";
$l['nav_avatar'] = "アバターを変更";
$l['nav_notepad'] = "個人用メモ帳";
$l['nav_editlists'] = "バディと無視リストの管理";
$l['nav_drafts'] = "保存された下書き";
$l['nav_usergroups'] = "グループメンバーシップ";
$l['nav_attachments'] = "添付ファイルマネージー";
$l['nav_addsubscription'] = "サブスクリプションを追加";

$l['resend_activation'] = "有効化メールを再送信";
$l['away_notice_away'] = "{1}から不在であるとマークされました。";
$l['away_notice'] = "このオプションを使用すると、不在かどうかを選択できます。";
$l['already_uploaded_avatar'] = "現在、アップロードされた画像を使用しています。別の画像を使用することを選択した場合、古いアバター画像はサーバーから削除されます。";
$l['using_remote_avatar'] = "現在、リモートサイトの画像を使用しています。別のURLを使用する場合、古いURLは削除されます。";
$l['na_deleted'] = "N/A - 削除済み";
$l['user_cp'] = "ユーザーコントロールパネル";
$l['user_cp_welcome'] = "これがユーザーコントロールパネルです。ここからプロファイル、サブスクリプション、プライベートメッセージにアクセスできます。<br>メインページにはアカウントに関する情報があります。";
$l['account_summary'] = "アカウント概要";
$l['username'] = "ユーザー名:";
$l['user_id'] = "ユーザーID:";
$l['title'] = "ユーザータイトル:";
$l['postnum'] = "投稿数:";
$l['posts_day'] = "(一日当たり {1} | 全体の {2} %)";
...
$l['birthday'] = "生年月日:";
$l['birthdayprivacy'] = "生年月日プライバシー:";
$l['birthdayprivacyall'] = "年齢と生年月日を表示";
$l['birthdayprivacynone'] = "年齢と生年月日を非表示";
$l['birthdayprivacyage'] = "年齢のみを表示";
$l['avatar'] = "アバター:";
$l['avatar_mine'] = "これがあなたのアバターです。";
$l['change_avatar'] = "アバターを変更";
$l['avatar_url'] = "アバターURL:";
$l['avatar_url_note'] = "インターネット上のアバターのURLを入力";
$l['avatar_url_gravatar'] = "<a href=\"https://gravatar.com\" target=\"_blank\" rel=\"noopener\">Gravatar</a>を使用するにはGravatarのEメールを入力";
$l['avatar_upload'] = "アバターをアップロード:";
$l['avatar_upload_note'] = "ローカルコンピューターでアップロードするアバターを選択する。";
$l['no_avatar'] = "アバターなし";
$l['no_avatar_note'] = "アバターが必要ない場合は、このオプションを選択";
$l['change_username'] = "ユーザー名を変更";
$l['new_username'] = "新しいユーザー名:";
$l['update_username'] = "ユーザー名を更新";
$l['edit_lists'] = "バディリストと無視リストを編集";
$l['edit_buddy_list'] = "バディリストを編集";
